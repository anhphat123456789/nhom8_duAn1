                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- add-new-user -->
                                <form action="<?= BASE_URL ?>?role=admin&act=update-post-user&id=<?= $_GET['id'] ?>" class="form-add-new-user form-style-2" method="post" enctype="multipart/form-data">
                                    <div class="wg-box">
                                        ...
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" id="name" placeholder="Name" name="name"   value="<?= $user->name ?>">
                                            </fieldset>
                                            <fieldset class="email mb-24">
                                                <div class="body-title mb-10" for="email">Email</div>
                                                <input class="flex-grow" type="email" id="email" placeholder="Email" name="email"  value="<?= $user->email ?>">
                                            </fieldset>
                                            <fieldset class="password mb-24">
                                                <div class="body-title mb-10">Password</div>
                                                <input class="password-input" type="password" id="password" placeholder="Password" name="password" >
                                            ...
                                            <fieldset class="address mb-24">
                                                ...
                                                <input class="flex-grow" type="text" id="address" placeholder="Address" name="address"  value="<?= $user->address ?>">
                                            </fieldset>
                                            <fieldset class="phone mb-24">
                                                <div for="phone" class="body-title mb-10">Phone</div>
                                                <input class="flex-grow" type="text" id="phone" placeholder="Phone" name="phone"  value="<?= $user->phone ?>">
                                            </fieldset>
                                            <fieldset class="image mb-24">
                                                <div for="image" class="body-title mb-10">Anh</div>
                                                <img src="<?= $user->image ?>" alt="" srcset="" width="50px">
                                                <input class="flex-grow" type="file" id="image" name="image"  accept="image/*">
                                            </fieldset>
