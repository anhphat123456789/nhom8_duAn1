                ...
                <div class="container-fluid">
                    <div class="card card-table">
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?= BASE_URL ?>?role=admin&act=add-post-product" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="pricesale" class="form-control " id="price_sale">
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-solid">Thêm sản phẩm</button>
                            </form>
                        </div>
                    </div>
                </div>
