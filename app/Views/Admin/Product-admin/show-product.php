                    ...
                    <div class="card card-table">
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?= BASE_URL ?>?role=admin&act=update-post-product&id=<?= $_GET['id'] ?>" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label>Giá:</label>
                                    <input type="number" name="price" class="form-control" id="price" value="<?= $product->price ?>" readonly>
                                </div>
                                <div class="mb-3">
                                    <label>Giá khuyến mãi:</label>
                                    <input type="number" name="pricesale" class="form-control " id="price_sale" value="<?= $product->price_sale ?>" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label>Tồn kho:</label>
                                    <input type="number" name="stock" class="form-control" id="stock" value="<?= $product->stock ?>" readonly>
                                </div>
                                <div class="mb-3">
                                    <label>Mô tả:</label>
                                    <textarea readonly name="description" class="form-control" id="description">
                                    <?= $product->description ?>
                                    </textarea>
                                </div>
                                <div class="mb-3">
                                    <label>Hình ảnh:</label>
                                    <img src="<?= $product->image_main?>" alt="" width="50px" readonly>

                                </div>

                               
                            </form>
                            <a href="<?= BASE_URL ?>?role=admin&act=all-product"><button type="submit" class="btn btn-warning">Quay lai</button></a>
                        </div>
                    </div>
                </div>
            </div>
