                                ...
                                <div class="title-header option-title d-sm-flex d-block">
                                    ...
                                    <div class="right-options">
                                        <ul>
                                            ...
                                            <li>
                                                <a class="btn btn-solid" href="<?= BASE_URL ?>?role=admin&act=add-product">Add Product</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <table class="table all-package theme-table table-product dataTable no-footer" id="table_id">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 170px;">Stock</th>
                                                ...
                                                <?php foreach ($listProduct as $key => $value) : ?>
                                                    <tbody>
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td><?= $value->name ?></td>
                                                            <td>
                                                                <img src="<?= $value->image_main ?>" width="50px" alt="">
                                                            </td>
