                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            ...
                                            <div class="cart-info">
                                                ...
                                                <span class="remove-cart" onclick="handleUpdate('<?= $value->id ?>', 'delete')">Remove</span>
                                            </div>
                                        </td>
                ...
                let UI = `
                     <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            ...
                                            <div class="cart-info">
                                                <a href="<?= BASE_URL ?>?act=product-detail&product_id= ${item.product_id}" class="cart-title link"><?= $value->name ?></a>
                                             
                                                <span class="remove-cart" onclick="handleUpdate('${item.id}', 'delete')">Remove</span>
                                            </div>
                                        </td>
                                        <td class="tf-cart-item_price" cart-data-title="Price">
                                            <div class="cart-price">
                                        ...
                                        <td class="tf-cart-item_total" cart-data-title="Total">
                                            <div class="cart-total">
                                                 ${item.price_sale != null ? (Number(item.price_sale) * Number(item.quantity)).toLocaleString() : (Number(item.price) * Number(item.quantity)).toLocaleString()} VNĐ
