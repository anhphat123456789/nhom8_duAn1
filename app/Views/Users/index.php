...
<body class="preload-wrapper popup-loader">
    ...
    <div id="wrapper">
        <!-- Top Bar -->
           <?php include 'app/Views/Users/layout/contact.php' ?>
        <!-- /Top Bar -->
        <!-- Header -->
       <?php include 'app/Views/Users/layout/header.php' ?>
        <!-- /Header -->
        <!-- Slider -->
        <?php include 'app/Views/Users/layout/slideshow.php' ?>
        <!-- /Slider -->
        <!-- Marquee -->
        <?php include 'app/Views/Users/layout/marquee.php' ?>
        <!-- /Marquee -->
        <!-- Categories -->
        ...
        <!-- /Seller -->
        <!-- Lookbook -->
        <?php include 'app/Views/Users/layout/lookbook.php' ?>
        <!-- /Lookbook -->
        <!-- Testimonial -->
        ...
        <!-- /Shop Gram -->
        <!-- Icon box -->
        <?php include 'app/Views/Users/layout/iconbox.php' ?>
        <!-- /Icon box -->
        <!-- Footer -->
